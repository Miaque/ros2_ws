...
```bash
PHASE_INFO=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
