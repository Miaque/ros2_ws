...
- **Global scope**: `/home/ubuntu/workspace/ros2_ws/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ubuntu/workspace/ros2_ws/.codex/notes/`)
...
2. Glob `/home/ubuntu/workspace/ros2_ws/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/ubuntu/workspace/ros2_ws/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ubuntu/workspace/ros2_ws/.codex/notes/` — works in any directory
