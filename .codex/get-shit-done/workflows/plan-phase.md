...
@/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/references/ui-brand.md
</required_reading>
...
```bash
INIT=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
Extract from {{GSD_ARGS}}: phase number (integer or decimal like `2.1`), flags (`--research`, `--skip-research`, `--gaps`, `--skip-verify`, `--prd <filepath>`).
...
```bash
PHASE_INFO=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
5. Commit:
```bash
node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(${padded_phase}): generate context from PRD" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
...
```bash
PHASE_DESC=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" | jq -r '.section')
```
...
**If found:**
1. Read template: `/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/templates/VALIDATION.md`
...
```bash
UI_PHASE_CFG=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
UI_GATE_CFG=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" config-get workflow.ui_safety_gate 2>/dev/null || echo "true")
```
...
```bash
PHASE_SECTION=$(node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" 2>/dev/null)
...
2. Disable Nyquist with the exact command:
   `node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" config-set workflow.nyquist_validation false`
