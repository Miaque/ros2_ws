...
Use template from `/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/ubuntu/workspace/ros2_ws/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
